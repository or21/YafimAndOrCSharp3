namespace Ex03.GarageLogic
{
    public class Car : Vehicle
    {
        ...
        public Car(string iVehicleManufacturer, string iId, bool i_IsElectric, float i_CurrentAmountOfPowerSource, float i_CurrentAmountOfAir, string i_WheelManufacturer, eColor i_Color, int i_NumberOfDoors)
